...
| API | signature・結果 |
| --- | --- |
| EXIT_SUCCESS / EXIT_FAILURE / EXIT_CONFIGURATION / EXIT_AUTHENTICATION / EXIT_PLUGIN / EXIT_PARTIAL | CLI の stable integer exit status。意味は [CLI と設定](configuration-and-cli.md)。 |
