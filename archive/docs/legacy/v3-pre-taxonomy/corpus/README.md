...
- [CLI 参照](docs/v3/cli-reference.md)
- [設定参照](docs/v3/configuration-reference.md)
- [実行ライフサイクル](docs/v3/execution-lifecycle.md)
- [plugin 開発参照](docs/v3/plugin-development-reference.md)
...
- [既存 v3 記述の移管 ledger](docs/v3/legacy-v3-coverage.md)
